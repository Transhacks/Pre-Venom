    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (label.equalsIgnoreCase("giveegg")) {
                ...
                meta.setLore((new LoreBuilder()).write(ChatColor.YELLOW + "Special item").next().write(ChatColor.GRAY + "Heals " + ChatColor.RED + "2.5❤").next().write(ChatColor.GRAY + "10 seconds cooldown.").build());
